...
class TestGenerateSequenceController(unittest.TestCase):
    maxDiff = None
    ...
    def test_sequence_with_all_features(self):
        ...
        with open("tests/testdata/sequence_controller_with_all_features.txt") as f:
    ...
    def test_sequence_no_condition(self):
        ...
        with open("tests/testdata/sequence_controller_no_condition.txt") as f:
            expected = f.read().strip()
    ...
    def test_sequence_no_return_var(self):
        ...
        with open("tests/testdata/sequence_controller_no_return_var.txt") as f:
            expected = f.read().strip()
    ...
    def test_sequence_no_parameter(self):
        ...
        with open("tests/testdata/sequence_controller_no_parameter.txt") as f:
            expected = f.read().strip()
    ...
    def test_sequence_no_argument(self):
        ...
        with open("tests/testdata/sequence_controller_no_argument.txt") as f:
            expected = f.read().strip()
    ...
    def test_sequence_multiple_everything(self):
        ...
        with open("tests/testdata/sequence_controller_multiple_everything.txt") as f:
            expected = f.read().strip()
